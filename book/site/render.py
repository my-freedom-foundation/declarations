...
TEXT = {
    ...
    "en": {
        "title": "In the People's Name",
        "subtitle": "Privilege, Revolution, and Unaccountable Power",
        "contents": "Contents",
        "start": "Start reading",
        "previous": "Previous",
        "following": "Next",
...
class Renderer:
    ...
    def shell(self, lang, key, title, main, sidebar=True):
        ...
        side = (
            f'<aside class="sidebar"><a class="contents-heading" href="{self.url(lang + "/")}">{t["contents"]}</a><nav aria-label="{t["contents"]}">{nav}</nav><a class="sidebar-download" href="{self.url("downloads/in-the-peoples-name-" + lang + ".epub")}" download>{t["download"]} ↓</a></aside>'
            if sidebar
            else ""
        )
        mobile = (
...
<div class="edition-actions"><a class="primary-link" href="{self.url(lang + "/preface/")}">{t["start"]} <span aria-hidden="true">→</span></a><a href="{self.url("downloads/in-the-peoples-name-" + lang + ".epub")}" download>{t["download"]} ↓</a></div>
...
<div class="cover-rule"></div><h1>以人民之名</h1><p class="cover-subtitle">特权、革命与不受约束的权力</p>
<div lang="en" class="english-title"><h2>In the People's Name</h2><p>Privilege, Revolution, and Unaccountable Power</p></div>
<div class="edition-choices"><a class="edition-choice" href="{self.url("zh/")}"><span>中文阅读版</span><strong>阅读本书 <span aria-hidden="true">→</span></strong><small>十二章 · 注释与来源</small></a><a class="edition-choice" href="{self.url("en/")}" lang="en"><span>English edition</span><strong>Read the book <span aria-hidden="true">→</span></strong><small>Twelve chapters · Notes & sources</small></a></div>
        ...
        return self.shell(
            "zh", "home", "以人民之名 / In the People’s Name", body, False
        )
